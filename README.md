...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seedbank-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seedbank-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seedbank` can be installed with:

```
conda install seedbank
```

It is possible to list all of the versions of `seedbank` available on your platform with:
